...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  <div class="container-fluid">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/lanche/lista">Lanches</a>
	      </li>
	    </ul>
	  </div>
	</nav>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor: ${qtdeVendedor}</span>
	  	...
	  	<span class="badge rounded-pill bg-success">Bebida: ${qtdeBebida}</span>
	  	<span class="badge rounded-pill bg-danger">Lanche: ${qtdeLanche}</span>
